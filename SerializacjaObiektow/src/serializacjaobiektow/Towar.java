...
public class Towar implements Serializable{
    ...
    // TO CO PONIŻEJ JUŻ NIE POTRZEBNE BO MAMY SERIALIZACJE
    /**
    ...
    **/
    private void readObject(ObjectInputStream inS)throws IOException, ClassNotFoundException{
        //Metoda do czytania obiektów
        //można ją nadpisać aby odrazu sprawdzoło czy danymi nikt nie kombinował
        //wczytujemy domyślna metode i dopisujemy swoje zadania
        inS.defaultReadObject();
        if(haslo != null)
            if(!haslo.equals("tajne"))
                throw new IOException("Kicha to nie to hasło");
        System.out.println("Ja się teraz wywołuje z metody readObject");
    }
    ...
    //transient oznaczamy tym dane ktore nie beda podlegaly serializacji
}
